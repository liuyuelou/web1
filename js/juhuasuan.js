$(function() {
    ...
    setInterval(function() {
        var objTime = getTimer('2020-09-20 18:00:00');
        $(".day").html(objTime.dayTime);
        $(".hour").html(objTime.dayHours);
        $(".min").html(objTime.dayMinutes);
        $(".sec").html(objTime.daysec);
...
$(function() {
    $(".crazy-bd .crazy-bd-card").click(function() {
        var arr = ["a", "b", "c", "d", "E"];
...
$(function() {
    $("#fengsuannai").mouseenter(function() {
        $(".head-cart").css("display", "none")
    })
    $("#fengsuannai").mouseleave(function() {
